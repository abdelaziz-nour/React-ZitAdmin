...
import { BIG_GAP, UsersExportOptions } from "../../redux/app/constants";
...
interface ExportMenuProps {
  handleExport: (formData: UsersExportOptions, exportType: string) => void;
}

const UsersExportMenu = ({ handleExport }: ExportMenuProps) => {
  /**
   * i18n
   */
  ...
  const [temporaryExportOptions, setTemporaryExportOptions] = useState({
    username: true,
    email: true,
    store: true,
    storeId: true,
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        ...
                        name="storeId"
                        onChange={handleCheckBox}
                        value={exportOptions.storeId}
                      />
                    }
                    label={
                      <Typography variant="body1">{t("storeId")}</Typography>
                    }
                  />
                  <FormControlLabel
                    control={
...
export default UsersExportMenu;
