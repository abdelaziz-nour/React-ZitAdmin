...
const OrdersFilterMenu = ({ handleFilter }: FilterMenuProps) => {
  /**
   * i18n
   */
              ...
              <Stack gap={2} width="20rem">
                ...
                >
                  ...
                  <MenuItem value={"Preparing"}>
                    <Typography variant="body1">{t("Preparing")}</Typography>
                  </MenuItem>
                  <MenuItem value={"OnDelivery"}>
                    <Typography variant="body1">{t("OnDelivery")}</Typography>
                  </MenuItem>
                  <MenuItem value={"Delivered"}>
                    <Typography variant="body1">{t("Delivered")}</Typography>
                  </MenuItem>
                ...
                <SubmitButton text="applyFilter" type="submit" />
              </Stack>
            </form>
          </Box>
        </MenuItem>
